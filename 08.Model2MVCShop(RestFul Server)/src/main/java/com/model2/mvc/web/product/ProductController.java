...
public class ProductController {
	...
	@RequestMapping(value="updateProduct", method=RequestMethod.GET) // 위에서 getProduct가 get방식. forward하면 유지 //안함
	...
	@RequestMapping(value="updateProduct",method=RequestMethod.POST) //2019.05.13
